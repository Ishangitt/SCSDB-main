  ...
  return (
    <div className="flex flex-col md:flex-row w-full h-full min-h-screen">
      ...
      <div className="w-full md:w-[80%] h-full overflow-auto overflow-x-hidden p-0 m-0">
        ...
        {/* Trending Section */}
        <div className="p-6 md:p-8 flex flex-col md:flex-row md:justify-between md:items-center gap-4 border-b border-zinc-800">
          <div className="flex items-center gap-3">
            <div className="w-1 h-8 bg-gradient-to-b from-[#6556CD] to-transparent rounded-full"></div>
            <div>
              <h1 className="text-3xl md:text-4xl font-bold text-white">Trending Now</h1>
              <p className="text-sm text-zinc-400 mt-1">What's popular today</p>
            </div>
          </div>
          <Dropdown
            title="Filter"
        ...
        {popular && (
          <>
            <div className="p-6 md:p-8 border-b border-zinc-800">
              ...
              <p className="text-sm text-zinc-400 ml-4">Most watched right now</p>
            </div>
        ...
        {topRated && (
          <>
            <div className="p-6 md:p-8 border-b border-zinc-800">
              ...
              <p className="text-sm text-zinc-400 ml-4">Highest rated on TMDB</p>
            </div>
        ...
        {upcoming && (
          <>
            <div className="p-6 md:p-8 border-b border-zinc-800">
              ...
              <p className="text-sm text-zinc-400 ml-4">Coming soon to theaters</p>
            </div>
